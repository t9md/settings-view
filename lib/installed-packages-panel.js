...
export default class InstalledPackagesPanel extends CollapsibleSectionPanel {
  ...
  constructor (settingsView, packageManager) {
    ...
    this.subscriptions.add(
      this.packageManager.on(
        'package-updated package-installed package-uninstalled package-installed-alternative',
        () => {
          ...
          <div className='section-container'>
            ...
            <section ref='deprecatedSection' className='sub-section deprecated-packages'>
              <h3 ref='deprecatedPackagesHeader' className='sub-section-heading icon icon-package'>
                Deprecated Packages
                <span ref='deprecatedCount' className='section-heading-count badge badge-flexible'>
                  …
                </span>
              </h3>
              ...
              <div ref='deprecatedPackages' className='container package-container'>
                <div ref='deprecatedLoadingArea' className='alert alert-info loading-area icon icon-hourglass'>
                  Loading packages…
                </div>
              </div>
            </section>
            ...
            <section className='sub-section installed-packages'>
              ...
              <div ref='communityPackages' className='container package-container'>
                <div ref='communityLoadingArea' className='alert alert-info loading-area icon icon-hourglass'>
                  Loading packages…
                </div>
              </div>
            </section>
            ...
            <section className='sub-section core-packages'>
              ...
              <div ref='corePackages' className='container package-container'>
                <div ref='coreLoadingArea' className='alert alert-info loading-area icon icon-hourglass'>
                  Loading packages…
                </div>
              </div>
            </section>
            ...
            <section className='sub-section dev-packages'>
              ...
              <div ref='devPackages' className='container package-container'>
                <div ref='devLoadingArea' className='alert alert-info loading-area icon icon-hourglass'>
                  Loading packages…
                </div>
              </div>
            </section>
            ...
            <section className='sub-section git-packages'>
              ...
              <div ref='gitPackages' className='container package-container'>
                <div ref='gitLoadingArea' className='alert alert-info loading-area icon icon-hourglass'>
                  Loading packages…
                </div>
              </div>
            </section>
  ...
  updateUnfilteredSectionCounts () {
    this.updateSectionCount(
      this.refs.deprecatedPackagesHeader,
      this.refs.deprecatedCount,
      this.packages.deprecated.length
    )
    ...
    const totalPackages =
      this.packages.user.length + this.packages.core.length + this.packages.dev.length + this.packages.git.length
