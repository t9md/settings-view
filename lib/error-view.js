    ...
    return (
      <div className='error-message'>
        <div ref='alert' className='alert alert-danger alert-dismissable native-key-bindings' tabIndex='-1'>
          ...
          <a ref='detailsLink' className='alert-link error-link' onclick={() => this.toggleOutput()}>
            {'Show output\u2026'}
          </a>
  ...
  render () {
    return (
      <div>
        ...
        <div className='compile-tools-message'>
          <span>Read </span>
          <a className='link' href='https://github.com/atom/atom/blob/master/docs/build-instructions/windows.md'>
            here
          </a>
