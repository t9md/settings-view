...
function setAsDefaultProtocolClient () {
  ...
  return (
    isSupported() &&
    require('electron').remote.app.setAsDefaultProtocolClient('atom', process.execPath, ['--uri-handler', '--'])
  )
}
                ...
                <div className='control-group'>
                  <div className='controls'>
                    <label className='control-label'>
                      ...
                      <div className='setting-description'>{this.renderRegistrationDescription()}</div>
                    </label>
                    <button
                ...
                <div className='control-group'>
                  <div className='controls'>
                    ...
                    <select
                      ...
                      {schema.enum.map(({description, value}) => <option value={value}>{description}</option>)}
                    </select>
                  </div>
                </div>
